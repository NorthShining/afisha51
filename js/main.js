...
var makeNavPopupMenu = function() {
    for (var i = 0; i <= mainApp.numOfListDays; i++) {
        $("div.nav-popup-menu").append('<div class="nav-popup-menu-button" onClick="getFilmsList(' + i + 'jQuery(this)); closeNavPopupMenu();">' + mainApp.listGetFullDate[i].dateForPeople + '</div>');
    }
};
//--------------------------------------------------------------------------------------------
